...
class DecisionTree() :
    ...
    def __init__(self, max_branches = math.inf, min_samples = 1) :
        ...
        from .cython_decision_tree_functions import go_down_the_tree, CythonTrainDecisionTraining
    ...
    def predict(self, x_test) :
        ...
        def parallel_predict(self, prediction_data):
            ...
            with parallel_backend("threading", n_jobs = -1) :
                predictions.append(Parallel()(delayed(self.go_down_the_tree)(list(data_point), self.tree)  for data_point in
                                              prediction_data))
